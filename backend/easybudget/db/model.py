...
class User(MongoModel):
    ...
    def serialize(self):
        return {'id': str(self._id), 'username': self.username, 'password': self.password_sha2}
...
class Budget(MongoModel):
    ...
    transactions = fields.EmbeddedDocumentListField(Transaction, default=list, blank=True)
